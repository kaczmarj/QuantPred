...
def main():
    ...
    parser.add_option(
        ...
        action="store_false",
        dest="save_test",
        help="Make and save test set predictions",
    )
    parser.add_option(
        "-e",
        dest="n_epochs",
    ...
    output_length = int(
        params["seq_length"] / params["pool_width"]
    )  # needed for binned data
    ...
    # initialize trainer
    seqnn_trainer = trainer_class.Trainer(
        train_data,
        eval_data,
        out_model_path,
        options.n_epochs,
